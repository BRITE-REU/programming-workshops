...
author: "Tanya Karagiannis, Bioinformatics Graduate Program"
output:
  html_document
---

```{r 'setup chunks' , include=FALSE, eval=TRUE}
...
options(width=120)
require("knitr")
opts_knit$set(root.dir = "~/Desktop/R_Workshop/")
